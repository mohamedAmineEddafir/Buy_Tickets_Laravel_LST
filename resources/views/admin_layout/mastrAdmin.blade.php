...
<html lang="en" class="h-100">
	<head>
		...
		<link href="{{asset('frontend/css/vertical-responsive-menu.min.css')}}" rel="stylesheet">
		<link href="{{asset('frontend/css/analytics.css')}}" rel="stylesheet">
		<link href="{{asset('frontend/css/responsive.css')}}" rel="stylesheet">
		<link href="{{asset('frontend/css/night-mode.css')}}" rel="stylesheet">
		
		<!-- Vendor Stylesheets -->
		<link href="{{asset('frontend/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
		<link href="{{asset('frontend/vendor/OwlCarousel/assets/owl.carousel.')}}" rel="stylesheet">
		...
		<link href="{{asset('frontend/vendor/chartist/dist/chartist.min.css ')}}"rel="stylesheet">
		<link href="{{asset('frontend/vendor/chartist-plugin-tooltip/dist/chartist-plugin-tooltip.css')}}" rel="stylesheet">
    ...
    <body class="d-flex flex-column h-100">
     ...
     @yield('content')
        ...
        <script src="{{asset('frontend/vendor/chartist/dist/chartist.min.js')}}"></script>
        <script src="{{asset('frontend/vendor/chartist-plugin-tooltip/dist/chartist-plugin-tooltip.min.js')}}"></script>
